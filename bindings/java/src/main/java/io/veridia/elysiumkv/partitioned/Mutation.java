...
/**
 * A put or a delete. Deletion is a case of this type rather than a {@code null} value.
 *
 ...
 * replay does not have the problem, so it appears only on the incremental path this component
 * exists for. A delete therefore travels the log as an ordinary <em>value</em>, which compaction
 * keeps as the latest value for that key.
 *
